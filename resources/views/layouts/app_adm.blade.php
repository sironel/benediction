        ...
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm" style="background-color: #ccffcc;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                  <img src="images/edit.png" width="20">  {{ config('app.name', 'Laravel') }}
                </a>
        ...
        <main class="py-4">
            ...
            <div class="toast" id="myToast" style="position: absolute; top: 0; right: 0; min-width: 400px;" data-delay="5000" data-animation="true">
                  <div class="toast-header">
                    <strong class="mr-auto"><i class="fa fa-grav"></i> Benediction</strong>
                    <small>  </small>
           ...
           <div class="row">
                ...
                <div class="col-md-2 infoblock">
                    ...
                    <!-- The sidebar -->
                    <div class="sidebar">
                      <a class="active" href="/admin" ><i class="fa fa-home fa-1x px-1"></i>Accueil</a>
