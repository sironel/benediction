...
// ----------------ajouter famille---------------------------------------
      ...
      $("#b_famille").click(function (e) {
        ...
        e.preventDefault();
        var type = "POST";
        var ajaxurl = '/benediction/familles';
...
$("#b_produit").click(function (e) {
      ...
      $('#chargement').show();
        ...
        e.preventDefault();
        var type = "POST";
        var ajaxurl = '/benediction/produits';
...
$("#b_edit").on("click",  function (e) {
       if(($('#famill').val()).length==0 || ($('#articl').val()).length==0 ){
        ...
        e.preventDefault();
        var type = "PUT";
        var ajaxurl = '/benediction/produits/'+id;
...
$(function(){
    $(document).on("click", "a.editModalLink" , function (e) {
       id = $(this).data("value");
        ...
        $.ajax(
        {
            url: "/benediction/produits/"+id+"/edit",
            type: 'GET',
            dataType: "JSON",
